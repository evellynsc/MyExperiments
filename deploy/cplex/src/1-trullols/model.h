...
public:
    ...
    // TODO: is z really floating-point?
    IloBoolVarArray y;       // decision variables (choice of points)
    IloNumVarArray z;        // auxiliary variables (contribution to obj. function)
    
    IloExpr obj;             // objective function
    
    IloRangeArray constr1;   // constraint linking z and y variables
